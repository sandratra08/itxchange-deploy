...
export class InitTable1678020005902 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tag" ("id" BIGSERIAL NOT NULL, "name" character varying NOT NULL, CONSTRAINT "constraint_name" UNIQUE ("name"), CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "publication" ("id" SERIAL NOT NULL, "date" TIMESTAMP NOT NULL DEFAULT 'NOW()', "view" integer NOT NULL DEFAULT '0', "total_interactions" integer NOT NULL DEFAULT '0', "total_comments" integer NOT NULL DEFAULT '0', "type" character varying NOT NULL, "body" character varying NOT NULL, "file" character varying NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_8aea8363d5213896a78d8365fab" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
